...
function kmc2_scripts_and_styles() {
    ...
    if (!is_admin()) {
        ...
        // wp_register_script( $handle, $src, $deps, $ver, $in_footer );
        wp_register_script( 'kmc2-js', get_stylesheet_directory_uri() . '/library/js/kmc2-scripts.js', array( 'jquery', 'jquery-masonry' ), '', true );
        wp_register_script( 'kmc2-gallery', get_stylesheet_directory_uri() . '/library/js/gallery.js', array( 'jquery-masonry' ), '', true );
